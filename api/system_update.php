...
function getMigrations() {
    return [
        ...
        ['type'=>'tbl', 't'=>'meal_schedules', 'sql'=>"CREATE TABLE meal_schedules (id INT AUTO_INCREMENT PRIMARY KEY, name VARCHAR(100) NOT NULL, cutoff_time TIME NOT NULL, end_time TIME DEFAULT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci"],
        ['type'=>'col', 't'=>'meal_schedules', 'c'=>'end_time', 'sql'=>"ALTER TABLE meal_schedules ADD COLUMN end_time TIME DEFAULT NULL"],
